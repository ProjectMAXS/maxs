...
public class ContactNick extends AbstractContactCommand {

	public ContactNick() {
		super("nick");
		setHelp(ArgType.CONTACT_NICKNAME, "Lookup contact by nickname");
	}
	...
	public Message execute(String arguments, Command command, MAXSModuleIntentService service)
		...
		return processResult(mContactUtil.contactsByNickname(arguments));
	}
