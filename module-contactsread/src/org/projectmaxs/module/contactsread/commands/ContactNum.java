...
public class ContactNum extends AbstractContactCommand {

	public ContactNum() {
		super("num");
		setHelp(ArgType.NUMBER, "Lookup a contact by number");
	}
	...
	public Message execute(String arguments, Command command, MAXSModuleIntentService service)
		...
		return processResult(mContactUtil.contactsByNumber(arguments));
	}
