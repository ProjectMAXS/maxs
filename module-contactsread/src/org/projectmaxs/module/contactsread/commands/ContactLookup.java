...
public class ContactLookup extends AbstractContactCommand {

	public ContactLookup() {
		super("lookup", false, true);
		setHelp(ArgType.CONTACT_INFO, "Lookup a contact");
	}
	...
	public Message execute(String arguments, Command command, MAXSModuleIntentService service)
		...
		return processResult(mContactUtil.lookupContacts(arguments));
	}
