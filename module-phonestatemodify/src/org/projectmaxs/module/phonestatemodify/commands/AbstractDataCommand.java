...
public abstract class AbstractDataCommand extends AbstractPhonestateModifyCommand {

	public AbstractDataCommand(String subCommand, boolean isDefaultWithoutArguments,
			boolean isDefaultWithArguments) {
		super(ModuleService.sDATA, subCommand, isDefaultWithoutArguments, isDefaultWithArguments);
	}
