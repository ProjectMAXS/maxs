...
public class PhoneReject extends AbstractPhonestateModifyCommand {

	public PhoneReject() {
		super(ModuleService.sREJECT, "call", true);
		setHelp(ArgType.NONE, "Reject an incoming phone call");
	}
	...
	public Message execute(String arguments, Command command, MAXSModuleIntentService service)
		...
		boolean res = telephonyService.endCall();
		return new Message(BooleanElement.trueOrFalse("Successfully rejected phone call",
				"Could not reject phone call", "phone_call_reject", res));
	}
}
