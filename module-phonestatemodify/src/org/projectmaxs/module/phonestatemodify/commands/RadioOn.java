...
public class RadioOn extends AbstractRadioCommand {

	public RadioOn() {
		super("on", false, false);
		setHelp(ArgType.NONE, "Activiate the phones mobile radio");
	}
	...
	public Message execute(String arguments, Command command, MAXSModuleIntentService service)
		...
		boolean res = telephonyService.setRadio(true);
		return new Message(BooleanElement.successOrUnsuccessfully(" enabled mobile radio",
				"mobile_radio_enabled", res));
	}
}
