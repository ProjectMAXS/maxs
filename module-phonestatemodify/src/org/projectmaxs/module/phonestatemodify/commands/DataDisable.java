...
public class DataDisable extends AbstractDataCommand {

	public DataDisable() {
		super("disable", false, false);
		setHelp(ArgType.NONE, "Disable mobile data");
	}
	...
	public Message execute(String arguments, Command command, MAXSModuleIntentService service)
		...
		boolean res = telephonyService.disableDataConnectivity();
		return new Message(BooleanElement.successOrUnsuccessfully(" disabled mobile data",
				"mobile_data_disabled", res));
	}
}
