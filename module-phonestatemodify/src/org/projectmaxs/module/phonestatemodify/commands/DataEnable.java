...
public class DataEnable extends AbstractDataCommand {

	public DataEnable() {
		super("enable", false, false);
		setHelp(ArgType.NONE, "Enable mobile data");
	}
	...
	public Message execute(String arguments, Command command, MAXSModuleIntentService service)
		...
		boolean res = telephonyService.enableDataConnectivity();
		return new Message(BooleanElement.successOrUnsuccessfully(" enabled mobile data",
				"mobile_data_enabled", res));
	}
}
