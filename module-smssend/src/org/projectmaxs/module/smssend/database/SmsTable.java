...
public class SmsTable {
	...
	public static final String CREATE_TABLE =
		...
		" (" +
		 ...
		 COLUMN_NAME_RECEIVER + SMSSendDatabase.TEXT_TYPE + SMSSendDatabase.NOT_NULL +
		 COLUMN_NAME_SHORT_TEXT + SMSSendDatabase.TEXT_TYPE + SMSSendDatabase.NOT_NULL +
 		 COLUMN_NAME_PART_COUNT + SMSSendDatabase.INTEGER_TYPE + SMSSendDatabase.NOT_NULL +
		 COLUMN_NAME_DELIVERED_INTENTS + SMSSendDatabase.TEXT_TYPE +
