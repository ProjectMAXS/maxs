...
import org.projectmaxs.module.smsread.commands.SmsShow;
...
public class ModuleService extends MAXSModuleIntentService {
	...
	public ModuleService() {
		super(LOG, "maxs-module-smsread", sCOMMANDS);
	}

	// @formatter:off
	public static final ModuleInformation sMODULE_INFORMATION = new ModuleInformation(
			"org.projectmaxs.module.smsread",      // Package of the Module
			"MAXS Module SmsRead"                  // Name of the Module
			);
	// @formatter:on
	...
	static {
		...
		SupraCommand.register(SmsShow.class, commands);
