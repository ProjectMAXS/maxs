...
public class RootShellExecute extends AbstractShell {

	public RootShellExecute() {
		super(ModuleService.ROOT_SHELL, "execute", false, true);
		setHelp("command", "Try to execute a command with a root shell");
	}
