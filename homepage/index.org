...
device and receive notifications over XMPP. You can for example write
SMS on your desktop/laptop by sending a command over XMPP to MAXS
...
Get an overview about MAXS by having a look at the [[file:../documentation/introduction.org][Introduction]].
