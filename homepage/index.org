...
[[file:../documentation/sitemap.org][There is more Documentation available.]]
...
Offical non alpha/beta release pending. [[*Alpha%20Testing][Alpha/Beta testers welcome]] :)
...
- Continues Integration: http://projectmaxs.org/ci

- [[https://www.ohloh.net/p/maxs][Project MAXS @ ohloh.et]]

** MAXS Nightlies

Nightlies signed with the release key can be found as Artifacts of the
[[https://projectmaxs.atlassian.net/builds/browse/MAXS-RELEASE/][MAXS Nightly Release]] build plan. Select the recent build → Artifacts →
Release APKs.

For example for [[https://projectmaxs.atlassian.net/builds/browse/MAXS-RELEASE-5][build #5]]: [[https://projectmaxs.atlassian.net/builds/browse/MAXS-RELEASE-5/artifact][Artifacts]] → [[https://projectmaxs.atlassian.net/builds/browse/MAXS-RELEASE-5/artifact/JOB1/Release-APKs/][Release APKs]]
